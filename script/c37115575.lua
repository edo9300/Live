...
function c37115575.initial_effect(c)
	...
	e4:SetCondition(c37115575.arcon)
	...
	e8:SetCondition(c37115575.arcon)
...
function c37115575.arcon(e)
 	return e:GetHandler():IsSetCard(0x23)
 end
function c37115575.excon(e)
	return Duel.IsExistingMatchingCard(c37115575.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil) and e:GetHandler():IsSetCard(0x23)
end
