...
function c36521459.initial_effect(c)
	...
	e4:SetCondition(c36521459.arcon)
	...
	e8:SetCondition(c36521459.arcon)
...
function c36521459.arcon(e)
 	return e:GetHandler():IsSetCard(0x23)
 end
function c36521459.excon(e)
	return Duel.IsExistingMatchingCard(c36521459.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil) and e:GetHandler():IsSetCard(0x23)
end
