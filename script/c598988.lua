...
function c598988.arcon(e)
 	return e:GetHandler():IsSetCard(0x23)
 end
function c598988.excon(e)
	return Duel.IsExistingMatchingCard(c598988.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil) and e:GetHandler():IsSetCard(0x23)
end
