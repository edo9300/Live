...
function c55343236.initial_effect(c)
	...
	e4:SetCondition(c55343236.arcon)
	...
	e8:SetCondition(c55343236.arcon)
...
function c55343236.arcon(e)
 	return e:GetHandler():IsSetCard(0x23)
 end
function c55343236.excon(e)
	return Duel.IsExistingMatchingCard(c55343236.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil) and e:GetHandler():IsSetCard(0x23)
end
