...
function c1710476.initial_effect(c)
	...
	e4:SetCondition(c1710476.arcon)
	...
	e8:SetCondition(c1710476.arcon)
...
function c1710476.arcon(e)
 	return e:GetHandler():IsSetCard(0x23)
 end
function c1710476.excon(e)
	return Duel.IsExistingMatchingCard(c1710476.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil) and e:GetHandler():IsSetCard(0x23)
end
