...
function c9433350.initial_effect(c)
	...
	e4:SetCondition(c9433350.arcon)
	...
	e8:SetCondition(c9433350.arcon)
...
function c9433350.arcon(e)
 	return e:GetHandler():IsSetCard(0x23)
 end
function c9433350.excon(e)
	return Duel.IsExistingMatchingCard(c9433350.exfilter,0,LOCATION_MZONE,LOCATION_MZONE,1,nil) and e:GetHandler():IsSetCard(0x23)
end
